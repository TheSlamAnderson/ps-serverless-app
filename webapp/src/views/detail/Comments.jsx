			...
			return (
				<>
					{comments.map((comment) => (
						<Comment comment={comment} key={comment.SK} />
					))}
				</>
			);
		}
		return <Typography variant="body2">No comments yet. You can start the discussion.</Typography>;
	};
